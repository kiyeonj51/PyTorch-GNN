        ...
        for line in f:
            ...
            if len(tokens) == 4:
                ...
                if tokens[2] == 'path':
                    ...
                    questions.append((question_type, src_id, tgt_id, label) if label is not None else (
                    question_type, src_id, tgt_id))
...
if __name__ == '__main__':
    ...
    parser.add_argument('input_dir', default='symbolic',
                        help='Path to the directory that contains generated raw symbolic data, should contain two directories train and test.')
    parser.add_argument('output_dir', default='processed',
                        help='Path to the directory to store processed symbolic data.')
